...
from config import get_claude_model, get_claude_timeout, get_config
...
class ClaudeClient:
    ...
    def __init__(self, api_key: str | None = None, model: str | None = None):
        ...
        Args:
            api_key (str | None, optional): Anthropic API key. If None, will attempt to
                use the ANTHROPIC_API_KEY environment variable. Defaults to None.
            model (str | None, optional): The Claude model to use. If None, uses configured default.
        ...
        if not self.api_key:
            ...
            raise RuntimeError(
                "API key is required. Set ANTHROPIC_API_KEY environment variable or provide api_key parameter"
            )
    ...
    def analyze_system(self, system_info: dict[str, str], language: str = "en") -> str:
        ...
        Args:
            system_info (dict[str, str]): Dictionary containing all the collected system information
        ...
        try:
            ...
            logger.debug(
                f"Received response of {len(response.content[0].text)} characters from Claude API"
            )
    ...
    def _generate_prompt(self, system_info: dict[str, str], language: str) -> str:
        ...
        Args:
            system_info (dict[str, str]): The collected system information dictionary
